"""
Extract config module for hypospadias - participant phenotypes.
...
source_data_url = "file://../data/hypospadias/hypospadiasParticipantPhenotypes.tsv"
...
operations = [
    ...
    keep_map(in_col="Age at Onset Units", out_col=CONCEPT.PHENOTYPE.EVENT_AGE.UNITS),
    value_map(
